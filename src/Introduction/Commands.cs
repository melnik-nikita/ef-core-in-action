...
public static class Commands
{
    ...
    /**************************************************************
    * We create the application's DbContext through which all database accesses are done
    * This reads all the books. The AsNoTracking() says this is a read-only access
